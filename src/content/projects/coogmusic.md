...
image: https://i.imgur.com/WYPg8OQ.png
github: https://github.com/k0src/COSC-3380-Project
---

## CoogMusic

![CoogMusic Screenshot](https://raw.githubusercontent.com/k0src/COSC-3380-Project/refs/heads/master/assets/homepage.png)

🔗 [GitHub Repository](https://github.com/k0src/COSC-3380-Project) / 🌐 [Live Website](https://cosc-3380.azurewebsites.net/)
...
- **Client**:
  - React, TypeScript, Tauri (for the standalone app), Vite
- **Server**:
